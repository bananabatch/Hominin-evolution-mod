...
public class BandMemberModel extends PlayerModel<BandMember> {
    ...
    private static final List<Held> HELD = List.of(
            ...
            new Held(ModItems.BONE_CLUB, id("club_hold"), id("club_swing")),
            new Held(ModItems.SCHONINGEN_SPEAR, id("spear_hold"), id("spear_thrust")),
            new Held(ModItems.STONE_TIPPED_SPEAR, id("stone_tipped_hold"), id("stone_tipped_thrust")),
            new Held(ModItems.KNIFE, id("knife_hold"), id("knife_slash")),
            new Held(ModItems.LEVALLOIS_FLAKE, null, id("levallois_slash")),
            new Held(ModItems.LEVALLOIS_BLADE, null, id("levallois_slash")),
            new Held(ModItems.LEVALLOIS_HAND_AXE, id("hand_axe_hold"), id("hand_axe_slash")),
